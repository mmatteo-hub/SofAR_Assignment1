...
class RobotController(Node) :
    ...
    def ask_for_pose(self, pose_name):
        # Logging the info to the user
        self.get_logger().info("Prompt "+pose_name+" position: ")
        # Obtaining and storing the pose
        return array_to_pose(list(map(float,input().split())))
    ...
    def create_navigator(self):
        ...
        # Asking the user for the initial pose
        self._poses[0] = self.ask_for_pose("initial")
    ...
    def check_and_set_next_goal(self):
        ...
        self._poses[self._goal_index] = self.ask_for_pose("goal")
