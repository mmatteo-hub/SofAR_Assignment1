...
class BasicNavigator(Node):
    ...
    def __init__(self, namespace=""):
        ...
        self.nav_through_poses_client = ActionClient(self,NavigateThroughPoses, namespace+'/navigate_through_poses')
        ...
        self.compute_path_through_poses_client = ActionClient(self, ComputePathThroughPoses, namespace+'/compute_path_through_poses')
