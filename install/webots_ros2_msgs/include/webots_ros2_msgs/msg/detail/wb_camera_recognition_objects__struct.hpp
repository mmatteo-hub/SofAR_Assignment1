...
struct WbCameraRecognitionObjects_
{
  ...
  _header_type header;
  using _objects_type =
    std::vector<webots_ros2_msgs::msg::WbCameraRecognitionObject_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<webots_ros2_msgs::msg::WbCameraRecognitionObject_<ContainerAllocator>>>;
  ...
  Type & set__objects(
    const std::vector<webots_ros2_msgs::msg::WbCameraRecognitionObject_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<webots_ros2_msgs::msg::WbCameraRecognitionObject_<ContainerAllocator>>> & _arg)
  {
    this->objects = _arg;
    return *this;
  }
